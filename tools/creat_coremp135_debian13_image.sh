...
[ -d 'build_coremp135_debian13' ] || mkdir -p build_coremp135_debian13/debian-minimal-armhf
export ROOTFS_SIZE="1024M"
./creat_coremp135_buidlroot_image.sh && cp build_coremp135_buidlroot/CoreMP135_buildroot/output/images/sdcard.img build_coremp135_debian13/
[ -f 'build_coremp135_debian13/sdcard.img' ] || { echo "not found sdcard.img" && exit -1; }

pushd build_coremp135_debian13
[ -f 'debian-13-minimal-armhf-2025-04-02.tar.xz' ] || wget https://rcn-ee.com/rootfs/eewiki/minfs/debian-13-minimal-armhf-2025-04-02.tar.xz
[ -f 'debian-13-minimal-armhf-2025-04-02.tar.xz' ] || { echo "not found debian-13-minimal-armhf-2025-04-02.tar.xz" && exit -1; }
[ -d 'debian-minimal-armhf' ] || mkdir debian-minimal-armhf
tar -xJf debian-13-minimal-armhf-2025-04-02.tar.xz -C debian-minimal-armhf
...
date_str=`date +%Y%m%d`
image_name="M5_CoreMP135_debian13_$date_str.img"
